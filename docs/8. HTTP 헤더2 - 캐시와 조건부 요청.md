...
<details>
<summary>캐시 적용: cache-control: max-age=60 예시</summary>
...
<details>
<summary>세 번째 요청 - 캐시 시간 초과 예시</summary>
...
<details>
<summary>검증 헤더 추가: if-modified-since, Last-Modified 예시</summary>
